    ...
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="w-full max-w-md space-y-8">
        <div className="text-center">
          ...
          <h1 className="mt-6 text-3xl font-bold tracking-tight">Let's get you started</h1>
          <p className="mt-2 text-muted-foreground">Create awesome content in minutes, not hours</p>
        </div>
